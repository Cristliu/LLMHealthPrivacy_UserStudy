...
module.exports = function (grunt) {
  ...
  Object.keys(configBridge.paths).forEach(function (key) {
    configBridge.paths[key].forEach(function (val, i, arr) {
      arr[i] = path.join('./docs/ntmapp', val);
    });
  });
  ...
  grunt.initConfig({
    ...
    jshint: {
      ...
      assets: {
        src: ['docs/ntmapp/js/src/*.js', 'docs/ntmapp/js/*.js', '!docs/ntmapp/js/*.min.js']
      }
    },
    ...
    uglify: {
      ...
      customize: {
        ...
        dest: 'docs/ntmapp/js/customize.min.js'
      },
      docs: {
        src: configBridge.paths.docsJs,
        dest: 'docs/ntmapp/js/docs.min.js'
      }
    },
    ...
    less: {
      ...
      docs: {
        options: {
          ...
          sourceMapFilename: 'docs/ntmapp/css/docs.css.map'
        },
        src: 'docs/ntmapp/less/docs.less',
        dest: 'docs/ntmapp/css/docs.css'
      },
      docsIe: {
        options: {
          sourceMap: false
        },
        src: 'docs/ntmapp/less/ie10-viewport-bug-workaround.less',
        dest: 'docs/ntmapp/css/ie10-viewport-bug-workaround.css'
      }
    },
    ...
    cssmin: {
      ...
      docs: {
        src: 'docs/ntmapp/css/docs.css',
        dest: 'docs/ntmapp/css/docs.min.css'
      }
    },
  ...
  grunt.registerTask('lint-docs-js', ['jshint:ntmapp', 'jscs:ntmapp']);
